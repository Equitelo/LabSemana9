...
public class SwingTunes extends javax.swing.JFrame {
    
    JTunes h;
    
    public SwingTunes(JTunes h) {
        this.h=h;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnAdd.setText("Agregar Canción");
        ...
        btnSearch.setText("Buscar Canción");
        ...
        btnPrint.setText("Imprimir Canciones");
        ...
        btnRate.setText("Reseña Canción");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwingTunes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SwingTunes(new JTunes()).setVisible(true);
            }
        });
    }
